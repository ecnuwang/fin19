...
\begin{aligned}
 ...
 =& E\left[ [\widehat{\mathbf{AR}}_{i} - \mathbf{X}^*_i(\hat{\theta}_i-\theta_i)] [\widehat{\mathbf{AR}}_{i} - \mathbf{X}^*_i(\hat{\theta}_i-\theta_i)]^T | \mathbf{X}^*_i \right]\\
 =& E\left[ \widehat{\mathbf{AR}}_{i} \widehat{\mathbf{AR}}_{i}^T - \widehat{\mathbf{AR}}_{i}(\hat{\theta}_i-\theta_i)^T \mathbf{X}^{*T}_i - \mathbf{X}^*_i(\hat{\theta}_i-\theta_i)\widehat{\mathbf{AR}}_{i}^T \right.\\
